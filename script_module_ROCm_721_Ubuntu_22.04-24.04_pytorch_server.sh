#!/bin/bash
# ================================================================================================================
# ROCm 7.2.1 + OpenCL 2.x + PyTorch 2.12.x (Preview (Nightly)) + Transformers + Docker Setup
# Compatible with Ubuntu 22.04.x and 24.04.x (Desktop & Server) — Ubuntu 20.04.x is no longer supported
# ================================================================================================================
# Description:
# This script automates the installation of AMD ROCm 7.2.1, PyTorch 2.12.x (Preview (Nightly)), Transformers, and Docker
...
# ---------------------------------------------------------------------------------------------------------------
# ROCm Platform:         7.2.1
# ROCm Release Notes:    https://rocm.docs.amd.com/en/docs-7.2.1/about/release-notes.html
# ROCm Driver Repo:      https://repo.radeon.com/amdgpu-install/7.2.1/ubuntu/
#
# PyTorch:               2.12.0.dev20260401+rocm7.2
# Transformers:          5.1.0
# Docker:                29.3.1 min. 29.0.0 (the script will verify and skip installation if minimum requirements are installed)
#
# INCLUDED TOOLS:
# ---------------------------------------------------------------------------------------------------------------
...
install_focal() {
    print '\nUbuntu 20.04.x (focal) is not longer be supported for ROCm 7.2.1 The last supported version is ROCm 6.4.0.\n'
...
install_jellyfish() {
    ...
    print '\n 📦 Installing ROCm 7.2.1 + OCL 2.x environment ...\n'
...
print ' ✅ Finished ROCm 7.2.1 + OCL 2.x + PyTorch 2.12.x (Preview (Nightly)) + Transformers environment installation and setup.\n'
